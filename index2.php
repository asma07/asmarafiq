...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
                ...
                <a class="navbar-brand" href="https://www.facebook.com/kbashir46">AR collection</a>
            </div>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <h4>First Product</h4>
                                <p>See more Dresses <a target="_blank" href="C:\Users\Apna Computer\Desktop\startbootstrap-shop-homepage-gh-pages\store">Click here</a>.</p>
    ...
    <div class="container">
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>See more Collection click on this link <a target="_blank" href="C:\Users\Apna Computer\Desktop\">Asma Collection.com</a>.</p>
                </div>
            </div>
        </footer>
